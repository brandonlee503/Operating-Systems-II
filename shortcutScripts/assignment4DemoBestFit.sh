...
# Source file - Usage: ". assignment4DemoBestFit.sh"
...
yes | cp -rf /scratch/spring2016/cs444-074/projects/project4/backupfiles/slob.c /scratch/spring2016/cs444-074/linux-yocto-3.14/mm/
make -j4 all
